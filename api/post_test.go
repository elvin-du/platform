...
func TestGetExplicitMentionsAtHere(t *testing.T) {
	...
	id := model.NewId()
	if mentions, hereMentioned := getExplicitMentions("@here @user", map[string][]string{"@user": []string{id}}); !hereMentioned {
...
func TestGetExplicitMentions(t *testing.T) {
	...
	keywords = map[string][]string{"@user": []string{id1}}
	...
	message = "this is a message for @user"
	keywords = map[string][]string{"this": []string{id1}}
	if mentions, _ := getExplicitMentions(message, keywords); len(mentions) != 1 || !mentions[id1] {
	...
	message = "this is a message for @user"
	keywords = map[string][]string{"@user": []string{id1, id2}}
	...
	keywords = map[string][]string{"@user": []string{id1}, "@mention": []string{id2}}
	...
	keywords = map[string][]string{"@channel": []string{id1, id2}}
	if mentions, _ := getExplicitMentions(message, keywords); len(mentions) != 2 || !mentions[id1] || !mentions[id2] {
	...
	keywords = map[string][]string{"@all": []string{id1, id2}}
	if mentions, _ := getExplicitMentions(message, keywords); len(mentions) != 2 || !mentions[id1] || !mentions[id2] {
	...
	keywords = map[string][]string{"user.period": []string{id1}, "user": []string{id2}}
	if mentions, _ := getExplicitMentions(message, keywords); len(mentions) != 1 || !mentions[id1] || mentions[id2] {
